...
// Example Taxonomic Group
const exampleTaxGroup = {
    name: "Example Group",
    optionalFields: [ "Comment", "Status" ],
    invalidFields: [ "Gender", "Number", "Observers", "Age" ],
...
class DatabaseSeeder {
    ...
    static seedDatabase() {
        return async function() {
            ...
            await tGroup.createGroup(exampleTaxGroup);
